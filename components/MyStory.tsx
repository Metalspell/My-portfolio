    ...
    >
      ...
      <div className="my-8">
        <p className="px-5 bg-gray-200 text-x1 dark:bg-dark-200 dark:bg-black-500 rounded-xl">
          ...
          I signed up for a Front-End Pro course at a local Hillel school, where I got a more thorough introduction to Frontend development. I finished the course with an A. I felt it wasn't enough for a real job. So after talking to a friend of mine, I decided to practice a bit and under his strict guidance, I started doing front-end for his personal website. At the end I was very proud of myself, because for a beginner it turned out very cool.
          After that, Pavel Yakovenko - engineer at SoftRequest - found me on ginny. He offered to join a team (TechMANGO) that will develop a website for his personal project - online poker, which he has been developing since his student days.
          However, the war in the country has made its changes. Unfortunately, the foreign investor decided to leave us and we had to say goodbye. Now, in spite of everything, I am looking for a team where I could realize myself and grow as an engineer.
        </p>
      </div>
    </div>
  );
